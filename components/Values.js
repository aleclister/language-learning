...
const Values = () => {
  return (
    <div className='container mx-auto py-14 md:py-20'>
        ...
        {/* Values Columns */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-16 py-10 lg:py-16">
            ...
            <div className="flex flex-col gap-5 items-center">
                ...
                <p className='text-2xl font-semibold text-center'>High quality content</p>
            ...
            <div className="flex flex-col gap-5 items-center">
                ...
                <p className='text-2xl font-semibold text-center'>Homework tools</p>
